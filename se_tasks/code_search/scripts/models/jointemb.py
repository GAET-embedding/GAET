...
class JointEmbeder(nn.Module):
    ...
    def __init__(self, config, vocab_size, embed_dim, embed_tensor, embed_type):
        ...
        self.api_encoder=SeqEncoder(vocab_size, embed_dim, config['lstm_dims'], None, 1)
        self.tok_encoder=BOWEncoder(vocab_size, embed_dim, config['n_hidden'], embed_tensor[1])
